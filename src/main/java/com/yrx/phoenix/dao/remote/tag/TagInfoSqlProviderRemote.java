...
public class TagInfoSqlProviderRemote {
     ...
     */
    public String countByExample(TagInfoExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("tag_info");
     ...
     * @mbg.generated Wed Feb 20 21:34:01 CST 2019
     */
    public String deleteByExample(TagInfoExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("tag_info");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Wed Feb 20 21:34:01 CST 2019
     */
    public String selectByExample(TagInfoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TagInfo record = (TagInfo) parameter.get("record");
        TagInfoExample example = (TagInfoExample) parameter.get("example");
     ...
     * @mbg.generated Wed Feb 20 21:34:01 CST 2019
     */
    protected void applyWhere(SQL sql, TagInfoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
