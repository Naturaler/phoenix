package com.yrx.phoenix.dao.remote.article;
...
public interface ArticleMapperRemote {
    /**
     ...
     */
    @SelectProvider(type= ArticleSqlProviderRemote.class, method="countByExample")
     ...
     * @mbg.generated Tue Feb 19 19:43:36 CST 2019
     */
    @DeleteProvider(type= ArticleSqlProviderRemote.class, method="deleteByExample")
     ...
     * @mbg.generated Tue Feb 19 19:43:36 CST 2019
     */
    @InsertProvider(type= ArticleSqlProviderRemote.class, method="insertSelective")
    @SelectKey(statement="SELECT LAST_INSERT_ID()", keyProperty="id", before=false, resultType=Integer.class)
     ...
     * @mbg.generated Tue Feb 19 19:43:36 CST 2019
     */
    @SelectProvider(type= ArticleSqlProviderRemote.class, method="selectByExample")
    @Results({
     ...
     * @mbg.generated Tue Feb 19 19:43:36 CST 2019
     */
    @UpdateProvider(type= ArticleSqlProviderRemote.class, method="updateByExampleSelective")
     ...
     * @mbg.generated Tue Feb 19 19:43:36 CST 2019
     */
    @UpdateProvider(type= ArticleSqlProviderRemote.class, method="updateByExample")
